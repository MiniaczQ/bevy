...
#import bevy_solari::global_illumination::view_bindings::{WORLD_CACHE_SIZE, WORLD_CACHE_DISCRETIZATION_FACTOR, WORLD_CACHE_MAX_SEARCH_STEPS, WORLD_CACHE_EMPTY_CELL, WORLD_CACHE_CELL_LIFETIME, world_cache_checksums, world_cache_life, world_cache_cell_data, world_cache_irradiance}
